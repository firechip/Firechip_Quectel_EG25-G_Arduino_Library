...
const char assistNowServer[] = "online-live1.services.Quectel.com";
//const char assistNowServer[] = "online-live2.services.Quectel.com"; // Alternate server
...
{
  // Use HTTP GET to receive the AssistNow_Online data. Store it in the EG25-G's internal file system.
