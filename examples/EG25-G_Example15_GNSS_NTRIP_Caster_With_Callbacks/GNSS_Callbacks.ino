...
// See Quectel_structs.h for the full definition of NMEA_GGA_data_t
...
void pushGPGGA(NMEA_GGA_data_t nmeaData)
{
  if (connectionOpen)
  {
    ...
    myEG25.socketWrite(socketNum, (const char *)nmeaData.nmea);
  }
}
...
// See Quectel_structs.h for the full definition of UBX_NAV_PVT_data_t
